...
export default function ReviewsPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Footer strip */}
      <footer className="bg-foreground text-white py-7 text-center mt-12 border-t-4 border-secondary">
        <p className="text-secondary font-hindi font-bold text-lg mb-1">|| श्री गणेशाय नमः || जय जवान जय किसान</p>
        <p className="text-white/50 text-sm mt-2">© 2026 Annadata Agri &amp; Seeds. All Rights Reserved.</p>
        <p className="text-white/30 text-xs mt-1.5">
          Designed &amp; Developed by{" "}
          <a href="https://www.instagram.com/priyamxmedia" target="_blank" rel="noreferrer"
            className="font-black tracking-widest text-secondary/70 hover:text-secondary transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(249,168,37,0.8)] hover:tracking-[0.2em]"
