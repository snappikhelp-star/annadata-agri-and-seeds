...
const MAPS_LINK = "https://maps.app.goo.gl/dy3bDjTpZpWxKrmo6?g_st=ic";
const GOOGLE_REVIEW_LINK = "https://g.page/r/Cd9LHCO3rFXuEBM/review";
  ...
  return (
    <section className="w-full pt-[118px]">
      <motion.div initial={{ opacity: 0, scale: 1.02 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1, ease: "easeOut" }} className="w-full relative">
        <img src={heroImagePath} alt="Annadata Agri & Seeds — Keshav Meena" className="w-full h-auto block" style={{ maxHeight: "92vh", objectFit: "cover", objectPosition: "center top" }} />
...
function CropDoctorSection() {
  ...
  const problems = [
    ...
    { emoji: "🌿", label: "घास / खरपतवार", tip: "खरपतवार से फसल की पैदावार 30–50% कम हो सकती है। खरपतवार नाशक जल्दी डालें।" },
    ...
    { emoji: "🧪", label: "कौन सी दवाई डालें?", tip: "फसल की अवस्था और समस्या देखकर सही दवाई चुनें। WhatsApp पर फोटो भेजें — फ्री सलाह पाएं।" },
  ];
  return (
  ...
  const months = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Crop Health Check", tip: "WhatsApp पर फोटो भेजें — फ्री सलाह" },
    ...
    <section className="py-14 md:py-20 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-2xl relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-foreground/60 font-hindi mt-2">नीचे फॉर्म भरें — Keshav Bhai WhatsApp पर Project की पूरी जानकारी देंगे</p>
          <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.8 }}
            className="w-24 h-1 bg-secondary mx-auto mt-4 rounded-full" />
        </div>
        <motion.form onSubmit={handleSubmit} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          className="bg-foreground rounded-3xl p-6 md:p-8 border border-secondary/20 shadow-2xl space-y-4"
          style={{ boxShadow: "0 20px 60px rgba(0,0,0,0.4)" }}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { name: "name", label: "आपका नाम *", placeholder: "जैसे: रामलाल पटेल", type: "text" },
              { name: "mobile", label: "मोबाइल नंबर *", placeholder: "10 अंकों का नंबर", type: "tel" },
              { name: "village", label: "गांव का नाम *", placeholder: "जैसे: बरेली गांव", type: "text" },
              { name: "acres", label: "कितने एकड़ *", placeholder: "जैसे: 5 एकड़", type: "text" },
              { name: "date", label: "कब लगाना है *", placeholder: "जैसे: 15 जुलाई", type: "text" },
            ].map(f => (
            ...
            <div className="sm:col-span-2">
              <label className="block text-white/70 font-hindi text-sm mb-1.5">धान Variety *</label>
...
function DhanUthwaiSection() {
  ...
  return (
    <section className="py-14 md:py-20 bg-foreground relative overflow-hidden border-t border-secondary/10">
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none"
        style={{ backgroundImage: "radial-gradient(circle at 1px 1px, #4CAF50 1px, transparent 0)", backgroundSize: "28px 28px" }} />
      <div className="container mx-auto px-4 md:px-6 max-w-2xl relative z-10">
        <div className="text-center mb-8">
          ...
          <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.8 }}
            className="w-24 h-1 bg-orange-400 mx-auto mt-4 rounded-full" />
        </div>
        <motion.form onSubmit={handleSubmit} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          className="bg-white/5 rounded-3xl p-6 md:p-8 border border-orange-400/20 shadow-2xl space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { name: "name", label: "आपका नाम *", placeholder: "जैसे: रामलाल पटेल" },
              { name: "mobile", label: "मोबाइल नंबर *", placeholder: "10 अंकों का नंबर" },
              { name: "village", label: "गांव का नाम *", placeholder: "जैसे: बरेली गांव" },
              { name: "qty", label: "अनुमानित Quantity *", placeholder: "जैसे: 50 बोरी / 2 टन" },
              { name: "harvest", label: "कटाई कब होगी? *", placeholder: "जैसे: अक्टूबर अंत" },
            ].map((f, i) => (
              <div key={f.name} className={i === 4 ? "sm:col-span-2" : ""}>
                ...
                <input name={f.name} placeholder={f.placeholder} value={(form as any)[f.name]} onChange={handleChange} required
                  className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white font-hindi placeholder-white/30 focus:outline-none focus:border-orange-400 transition-colors" />
              </div>
            ))}
          </div>
          <motion.button type="submit" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-7">
          {reasons.map((r, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              transition={{ delay: i * 0.08, duration: 0.5 }} whileHover={{ y: -6, scale: 1.02 }}
              ...
              <div className="absolute -top-8 -right-8 w-28 h-28 rounded-full blur-2xl opacity-15 group-hover:opacity-30 transition-opacity duration-500" style={{ background: r.color }} />
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-14 gap-5">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
            ...
            <div>
              <div className="flex text-secondary mb-1">{[...Array(5)].map((_, i) => <Star key={i} className="w-4 h-4 fill-current" />)}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mb-8">
          {testimonials.map((t, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              transition={{ delay: i * 0.15, duration: 0.5 }} whileHover={{ y: -4 }}
              ...
              <div className="flex text-secondary mb-4">{[...Array(t.rating)].map((_, j) => <Star key={j} className="w-5 h-5 fill-current" />)}</div>
...
function ReviewAssistantSection() {
  ...
  const services = ["धान बीज", "1886 Variety", "PB1 धान", "धान प्रोजेक्ट", "कीटनाशक / दवाई", "खरीदी / उठवाई", "किसान सलाह", "खरपतवार नाशक"];

  const templates: Record<string, Record<number, string>> = {
    "धान बीज": {
      5: "Annadata से धान का बीज लिया, अंकुरण बहुत अच्छा रहा। केशव भाई ने सही variety बताई। पूरी फसल शानदार हुई।",
      4: "धान बीज की quality अच्छी थी। केशव भाई की सलाह काम आई। अगले सीजन भी यहीं से लूंगा।",
      3: "बीज ठीक-ठाक था, delivery में थोड़ी देरी हुई। बाकी सब okay रहा।",
      2: "बीज से उतना result नहीं मिला जितनी उम्मीद थी। अगली बार पहले पूछकर लूंगा।",
      1: "इस बार बीज से result अच्छा नहीं आया। उम्मीद है अगली बार बेहतर होगा।",
    },
    "किसान सलाह": {
      5: "केशव भाई ने फसल की समस्या WhatsApp पर देखकर सही दवाई बताई। 3 दिन में फसल ठीक हो गई। बहुत शुक्रिया।",
      4: "फसल के रोग के बारे में अच्छी सलाह मिली। समय पर बताने से नुकसान से बचाव हुआ।",
      3: "सलाह मिली, थोड़ा समय लगा। पर काम आई।",
      2: "सलाह मिली, पर उतना फायदा नहीं हुआ जितनी उम्मीद थी।",
      1: "सलाह से मदद नहीं मिली इस बार।",
    },
  };

  const generateReview = () => {
    if (!rating || !service) return;
    const serviceTemplates = templates[service] || templates["किसान सलाह"];
    const base = serviceTemplates[rating] || `Annadata Agri से ${service} लिया। ${rating >= 4 ? "अच्छा अनुभव रहा।" : "ठीक-ठाक अनुभव रहा।"}`;
    setReview(base);
  };
    ...
    <section className="py-14 md:py-20 bg-[#F4F1EB] border-y border-border/50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-10">
          ...
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.2 }}
            className="text-muted-foreground font-hindi mt-2 text-base max-w-lg mx-auto">
            Rating और service चुनें — हम आपके लिए honest review तैयार करेंगे। आप edit करके Google पर Post करें।
          </motion.p>
          <motion.div initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} viewport={{ once: true }} transition={{ delay: 0.25, duration: 0.8 }}
            className="w-24 h-1 bg-secondary mx-auto mt-4 rounded-full" />
        </div>
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-3xl border border-border shadow-xl overflow-hidden">
          <div className="bg-primary p-5">
            <p className="text-secondary font-bold text-xs uppercase tracking-widest mb-1">Review Assistant</p>
            <h3 className="text-white font-hindi font-bold text-lg">Annadata Agri & Seeds — Google Review</h3>
          </div>
          <div className="p-6 flex flex-col gap-5">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                {rating > 0 && <span className="self-center text-sm font-hindi text-muted-foreground ml-1">
              ...
              <div className="flex flex-wrap gap-2">
                {services.map(s => (
                  <button key={s} onClick={() => setService(s)}
                    className={`px-3 py-2 rounded-full text-xs font-bold font-hindi border transition-all ${service === s ? "bg-primary text-white border-primary" : "bg-white text-foreground border-border hover:border-primary/50"}`}>
                    {s}
                  </button>
                ))}
              </div>
            ...
            <button onClick={generateReview} disabled={!rating || !service}
              className="w-full py-3 bg-primary text-white font-hindi font-bold rounded-xl disabled:opacity-40 disabled:cursor-not-allowed hover:bg-primary/90 transition-all hover:scale-[1.01]">
              ✨ Review Generate करें
            </button>

            {review && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                <label className="text-sm font-bold text-foreground/70 font-hindi mb-2 block">✏️ आपका Review (Edit कर सकते हैं)</label>
                ...
                <p className="text-xs text-muted-foreground font-hindi mt-1">यह एक सुझाव है — आप अपनी भाषा में बदल सकते हैं।</p>
                <div className="flex gap-3 mt-3">
                  <button onClick={copyReview}
                    ...
                    <Copy className="w-4 h-4" /> {copied ? "✅ Copied!" : "Review Copy करें"}
                  </button>
                  <a href={GOOGLE_REVIEW_LINK} target="_blank" rel="noreferrer"
                    ...
                    <FaGoogle className="w-4 h-4" /> Google पर Post करें
                  </a>
                </div>
              </motion.div>
            )}
  ...
  return (
    <section className="py-14 md:py-20 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-3xl relative z-10">
        ...
        <motion.form onSubmit={handleSubmit} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          className="bg-foreground rounded-3xl p-6 md:p-8 border-2 border-[#25D366]/30 shadow-2xl space-y-4"
            ...
            {[
              ...
              <div key={f.name}>
                ...
                <input name={f.name} type={f.type} placeholder={f.placeholder} value={(form as any)[f.name]}
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white font-hindi placeholder-white/30 focus:outline-none focus:border-[#25D366] transition-colors" />
              </div>
            ))}
            <div>
              <label className="block text-white/70 font-hindi text-sm mb-1.5">मुख्य फसल *</label>
              <select name="crop" value={form.crop} onChange={handleChange} required
                className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white font-hindi focus:outline-none focus:border-[#25D366] transition-colors">
...
function ContactSection() {
  ...
  const problems = ["धान बीज", "1886 / PB1 Variety", "धान प्रोजेक्ट", "धान की दवाई", "First Spray", "फसल रोग", "खरपतवार नाशक", "घर से उठवाई", "गेहूं बीज", "किसान सलाह", "अन्य"];
    ...
    <section className="py-16 md:py-24 bg-background relative z-10 border-t border-border/50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-10 md:mb-14">
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            className="text-3xl md:text-5xl font-hindi font-black text-foreground mb-3">
            सीधे Keshav Bhai से बात करें
          </motion.h2>
          <p className="text-muted-foreground font-hindi text-lg">हर समस्या का समाधान — WhatsApp, Call या Visit</p>
        </div>
